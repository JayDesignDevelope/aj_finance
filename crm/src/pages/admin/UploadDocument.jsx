...
export default function UploadDocument() {
  ...
  const [form, setForm] = useState({ customerId: '', loanId: '', docType: DOC_TYPES[0], fileName: '', status: 'Submitted' });
    ...
    <Layout title="Upload Document">
      <div className="page-header">
        <div className="page-header-left">
          <button className="btn btn-ghost btn-sm" onClick={() => navigate('/admin/documents')}><ArrowLeft size={16} /> Back</button>
      ...
      <div className="form-page-wrap">
        <form onSubmit={handleSubmit} className="card form-card">
          ...
          <div className="card-body form-grid">
            ...
            <div className="form-group">
              ...
              <select className="form-control" value={form.status} onChange={e => set('status', e.target.value)}>
                <option>Submitted</option><option>Pending</option><option>Verified</option>
              </select>
            </div>
            ...
            <div className="form-group form-span-2">
              ...
              <div style={{ position: 'relative' }}>
                <input className={`form-control${errors.fileName ? ' is-error' : ''}`} placeholder="e.g. aadhar_front.pdf"
          ...
          <div className="form-actions">
            <button type="button" className="btn btn-outline" onClick={() => navigate('/admin/documents')}>Cancel</button>
            <button type="submit" className="btn btn-primary" disabled={saving}>
              <Save size={14} /> {saving ? 'Saving…' : 'Upload Document'}
            </button>
          </div>
        </form>
      </div>
